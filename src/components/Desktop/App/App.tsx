...
const App = ({
    ...
    function draggable(e: React.MouseEvent<HTMLDivElement, MouseEvent>) {
        ...
        function drag(e: MouseEvent) {
            ...
            setArea({
                ...area,
                top: (Math.min(window.innerHeight - boundingClientRect.height, Math.max(infoBarHeight, (boundingClientRect.top - pos2))) + "px"),
                left: (Math.min(window.innerWidth - boundingClientRect.width, Math.max(appBarWidth, (boundingClientRect.left - pos1))) + "px")
            })
        }
    ...
    function resizable(e: React.MouseEvent<HTMLDivElement, MouseEvent>, direction: Direction) {
        e.preventDefault();
        ...
        function resize(e: MouseEvent) {
            ...
            switch (direction) {
                case Direction.TOP_LEFT:
                    if ((boundingClientRect.top - heightTop + boundingClientRect.height > infoBarHeight) && (heightTop > minimumSize.height)) {
                        setArea(prev => ({
                            ...prev,
                            top: Math.max(infoBarHeight, (boundingClientRect.top - heightTop + boundingClientRect.height)) + "px",
                            height: Math.max(minimumSize.height, heightTop) + "px"
                        }));
                    }
                    if ((boundingClientRect.left - widthLeft + boundingClientRect.width > appBarWidth) && (widthLeft > minimumSize.width)) {
                        setArea(prev => ({
                            ...prev,
                            left: Math.max(appBarWidth, (boundingClientRect.left - widthLeft + boundingClientRect.width)) + "px",
                ...
                case Direction.TOP_RIGHT:
                    ...
                    if (boundingClientRect.right + widthRight - boundingClientRect.width < window.innerWidth) {
                        setArea(prev => ({
                            ...prev,
                ...
                case Direction.BOTTOM_RIGHT:
                    ...
                    if (boundingClientRect.bottom + heightBottom - boundingClientRect.height < window.innerHeight) {
                        setArea(prev => ({
                            ...prev,
    ...
    return (
        <div className={isFullScreen ? "fullscreenApp" : "app"}
...
type ResizersProps = {
    resizable: (e: React.MouseEvent<HTMLDivElement, MouseEvent>, direction: Direction) => void
}

function Resizers({resizable}: ResizersProps) {
    return (
        <div className={"resizers"}>
            <div onMouseDown={(e) => resizable(e, Direction.TOP_LEFT)}
                 className={"resizer round top-left"}/>
            <div onMouseDown={(e) => resizable(e, Direction.TOP_RIGHT)}
                 className={"resizer round top-right"}/>
            <div onMouseDown={(e) => resizable(e, Direction.BOTTOM_LEFT)}
                 className={"resizer round bottom-left"}/>
            <div onMouseDown={(e) => resizable(e, Direction.BOTTOM_RIGHT)}
                 className={"resizer round bottom-right"}/>

            <div onMouseDown={(e) => resizable(e, Direction.LEFT)}
                 className={"resizer line left"}/>
            <div onMouseDown={(e) => resizable(e, Direction.RIGHT)}
                 className={"resizer line right"}/>
            <div onMouseDown={(e) => resizable(e, Direction.TOP)}
                 className={"resizer line top"}/>
            <div onMouseDown={(e) => resizable(e, Direction.BOTTOM)}
