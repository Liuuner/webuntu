...
/*
This file is originally from xterm-for-react by Robert Harbinson, but this component uses the newest version of xterm
...
export default class Xterm extends React.Component<IProps> {
  ...
  render() {
    return <div id={this.props.id} className={this.props.className} ref={this.terminalRef} />
  }
}